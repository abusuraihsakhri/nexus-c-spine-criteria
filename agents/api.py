"""
FastAPI REST API Server for Nexus C Spine Criteria.
"""
...
app = FastAPI(
    title="Nexus C Spine Criteria API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "nexus-c-spine-criteria", "domain": "Radiology & Neuroimaging Systems", "standard": "ACR RADS / Fleischner Society / ASPECTS Guidelines", "version": "3.0.0-ENTERPRISE"}
